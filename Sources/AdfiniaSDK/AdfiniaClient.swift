...
public final class AdfiniaClient {
    ...
    // internal (not private): the consent extension in AdfiniaClient+Consent.swift
    // needs these, matching how the push/inbox extensions use internal accessors.
